...
class TradeOffAnalyzer:
    ...
    @staticmethod
    def calculate_marginal_efficiency(baseline: ParetoPoint, compressed: ParetoPoint) -> Dict[str, float]:
        ...
        return {
            ...
            "retention_per_gb_saved": (retention_rate / max(0.1, vram_saved_gb)) if vram_saved_gb > 0 else 0.0,
        }
