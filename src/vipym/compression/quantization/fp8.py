...
class FP8CompressionMethod(CompressionMethod):
    ...
    def get_capabilities(self) -> PluginCapability:
        return PluginCapability(
            ...
            supported_dtypes={SupportedDtype.FP8_E4M3, SupportedDtype.FP8_E5M2, SupportedDtype.BF16},
            supports_moe=True,
    ...
    def compress(
        ...
        **kwargs: Any,
        ...
        logger.info(f"Executing FP8 quantization (format={self.format}, static_scales={self.static_scales})")
