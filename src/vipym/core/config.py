...
class ModelConfig(BaseModel):
    ...
    custom_adapter_cls: Optional[str] = Field(default=None, description="Custom ModelAdapter class name")
...
class CalibrationConfig(BaseModel):
    ...
    dataset_config: Optional[str] = Field(default="wikitext-2-raw-v1")
...
class EvaluationConfig(BaseModel):
    ...
    task_limit: Optional[int] = Field(default=None, description="Optional cap on number of tasks for smoke runs")
